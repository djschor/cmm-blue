...
import cmmSquare from '../../images/cmm-light.png';
    ...
    return (
      ...
      >
        <header className={s.logo}>
          {/* <a href="https://demo.flatlogic.com/light-blue-react/">Crypto Money Moves <span className="fw-bold butler">Blue</span></a> */}
          <img src={cmmSquare} alt="..." />
        </header>
        <ul className={s.nav}>
          <h5 className={[s.navTitle, s.groupTitle].join(' ')}>BLUE</h5>
          <LinksGroup
